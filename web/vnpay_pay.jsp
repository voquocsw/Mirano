...
<html lang="en">
    <head>
        ...
        <link href="View/jumbotron-narrow.css" rel="stylesheet">      
        <script src="View/jquery-1.11.3.min.js"></script>
        <style>
            .container-pay{
                ...
                <form action="ajaxServlet" id="frmCreateOrder" method="post">        
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex justify-content-center"> 
                            <button onclick="submit()" type="submit" class="btn btn-danger btn-pay" href>Thanh toán</button>
                        </div>
                </form>
            </div>
        </div>
