<%-- 
    ...
    Created on : Jul 19, 2023, 10:04:08 AM
    Author     : Aver
--%>
            ...
            <div class="d-flex justify-content-center align-items-center row">
                <div class="col-md-6 border">
                    <div class="p-3 py-5">
                        ...
                        <form action = "deleteTableController" method="post">
                            <div class="col-3">
                                <label class="col-md-3">Select Table: </label>
                                <select class="col-md-8 form-select"  name="table">
