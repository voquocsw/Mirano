...
<html>
    ...
    <body style="">
            ...
            <div class="invoice-container" ref="document" id="html">
                <table style="width:100%; height:auto;  text-align:center; " BORDER=0 CELLSPACING=0>
                    ...
                    <tbody style="background:#ffff;padding:20px;">
                        <tr>
                            <td colspan="4" style="padding:20px 0px 0px 20px;text-align:left;font-size: 20px; font-weight: bold;color:#000;">Hello, ${requestScope.name}</td>
                        </tr>
                        <tr>
        ...
        <div class="d-flex justify-content-center">
            <button style="margin: 45px auto"  class="button-74" onclick="window.location = 'homeController'">Go Home</button>
        </div>
        <!--homeController-->
